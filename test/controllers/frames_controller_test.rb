...
class FramesControllerTest < ActionController::TestCase
  ...
  test "should create frame" do
    assert_difference('Frame.count') do
      post :create, frame: { firstball: @frame.firstball, game_id: @frame.game_id, secondball: @frame.secondball, user_id: @frame.user_id }
    end
  ...
  test "should update frame" do
    patch :update, id: @frame, frame: { firstball: @frame.firstball, game_id: @frame.game_id, secondball: @frame.secondball, user_id: @frame.user_id }
    assert_redirected_to frame_path(assigns(:frame))
  end
